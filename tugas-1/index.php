...
<body id="page-top">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="<?= $_PATH_IMAGE; ?>undraw_posting_photo.svg" alt="...">
                                    </div>
    ...
    <script src="<?= $_PATH_ASSETS; ?>js/demo/chart-area-demo.js"></script>
    <script src="<?= $_PATH_ASSETS; ?>js/demo/chart-pie-demo.js"></script>
