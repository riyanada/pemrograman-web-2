            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('blog')) ? 'active' : '' }}" aria-current="page" href="{{ route('blog') }}">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('blog/kontak')) ? 'active' : '' }}" href="{{ route('blog.kontak') }}">Kontak</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('blog/tentang')) ? 'active' : '' }}" href="{{ route('blog.tentang') }}" tabindex="-1">Tentang</a>
                        </li>
                    </ul>
                    <form class="d-flex">
